...
public final class PrizePools {
	...
	private static PrizePools pool;
	 ...
	 * @return
	 */
	public synchronized static PrizePools createPool() {
		if (pool != null) {
			return pool;
		}
		return new PrizePools();
	}

	/**
	 * 初始化奖池的奖品信息
	 */
	public PrizePools init(int numberOfPeople, List<DrawPrize> prizes) {
